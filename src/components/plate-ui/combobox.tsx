    ...
    return (
      <div
        ...
        className={cn(
          ...
          'hover:tw-bg-accent hover:tw-text-accent-foreground data-[highlighted=true]:tw-bg-accent data-[highlighted=true]:tw-text-accent-foreground',
          className
        )}
        {...props}
        {...rest}
    ...
    <Popover.Root open>
      ...
      <Popover.Portal container={portalElement}>
        <Popover.Content
          ...
          align="start"
          className={cn(
            'tw-z-[500] tw-m-0 tw-max-h-[288px] tw-w-[300px] tw-overflow-scroll tw-rounded-md tw-bg-popover tw-p-0 tw-shadow-md'
          )}
