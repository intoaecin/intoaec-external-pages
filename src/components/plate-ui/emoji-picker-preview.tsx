...
function EmojiPreview({ emoji }: EmojiPreviewProps) {
  return (
    <div className='tw-flex tw-items-center tw-border-t tw-border-gray-100 tw-p-2'>
      <div className='tw-flex tw-items-center tw-justify-center tw-text-3xl'>
        {emoji?.skins[0].native}
      </div>
      <div className='tw-overflow-hidden tw-pl-2'>
        <div className='tw-truncate tw-text-sm tw-text-gray-600'>{emoji?.name}</div>
        <div className='tw-truncate tw-text-xs tw-text-muted-foreground'>{`:${emoji?.id}:`}</div>
      </div>
    </div>
  );
}
...
function NoEmoji({ i18n }: NoEmojiPreviewProps) {
  return (
    <div className='tw-flex tw-items-center tw-border-t tw-border-gray-100 tw-p-2'>
      ...
      <div className='tw-overflow-hidden tw-pl-2'>
        <div className='tw-truncate tw-text-sm tw-text-gray-600'>
...
function PickAnEmoji({ i18n }: PickAnEmojiPreviewProps) {
  return (
    <div className='tw-flex tw-items-center tw-border-t tw-border-gray-100 tw-p-2'>
      ...
      <div className='tw-overflow-hidden tw-pl-2'>
        <div className='tw-truncate tw-text-lg tw-text-muted-foreground'>
          {i18n.pick}
        </div>
      </div>
    </div>
