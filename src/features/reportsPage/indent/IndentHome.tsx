...
const IndentHome = () => {
    ...
    const columns = [
        ...
        { display: t("indentContent.indentNo") || "Indent No", field: "indentNo", isSort: true },
        { display: t("indentContent.indentType") || "Indent Type", field: "indentType", isSort: true },
        { display: t("common.status"), field: "status", isSort: true },
        { display: t("indentContent.issuedDate") || "Issued On", field: "issuedOn", isSort: true },
    ];
