...
type ClientReportNotesProps = {
  report: Pick<ClientReportRecord, "notes">;
  notes?: ClientReportNotePayload[];
  isPreview?: boolean;
  onNotesChange?: (notes: ClientReportNotePayload[]) => void;
};
...
const ClientReportNotes = ({
  report,
  notes,
  isPreview = false,
  onNotesChange,
}: ClientReportNotesProps) => {
  ...
  const handleDeleteNote = (noteId: string) => {
    ...
    setEditingTitleId((prev) => (prev === noteId ? null : prev));
  };
...
export default ClientReportNotes;
