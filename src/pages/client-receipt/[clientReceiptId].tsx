...
const ReceiptDocument = ({ data }: { data: ClientReceiptResult }) => {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default" }}>
      ...
      <Box className="receipt-sheet" sx={{ maxWidth: 1100, mx: "auto", my: { xs: 0, sm: 3 }, bgcolor: "background.paper", boxShadow: { sm: 1 }, p: { xs: 2, sm: 4 } }}>
        <Stack spacing={3}>
          <BusinessAndClientInfo type="CLIENT" projectId={receipt.receiverId} organizationId={receipt.senderId} withAuth={false} Display={false} isPreview />
